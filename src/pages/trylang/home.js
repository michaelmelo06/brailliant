...
import convertTextToBrailleDots from "../trylang/api/translate"; // Local function import
...
export default function App() {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    setLoading(true);
    const result = convertTextToBrailleDots(text); // Use local function instead of API
